...
import delta2.system.wsu.commands.ModuleExeCmdManager;

public class Module implements IModuleWorker, IError {

    public static final String _MODULE_CODE = "wsu";
    ...
    public String GetModuleID() {
        return "7326bd21-e1fc-45b6-bfa0-7fc30a59f5d5";
    }
    ...
    public String GetDescription() {
        return context.getResources().getString(R.string.wsu_module_name);
    }
