...
public class CmdCameraSet extends ExeBaseCmd {

    public static final String _COMMAND = "set camera ";

    public CmdCameraSet(Context c, IRequestSendMessage s) {
        super(c, s);
    }
    ...
    protected String RunCommand(ICmdParams params, String msgId) {
        PreferencesHelper.setCameraIdx (((ParamsInt)params).GetValue());
    ...
    public String GetHelp() {
        return String.format("%s - %s", GetCommandText(), context.getString(R.string.wmd_hc_camera_set));
    }
