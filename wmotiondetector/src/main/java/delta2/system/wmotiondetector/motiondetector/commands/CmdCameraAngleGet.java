...
public class CmdCameraAngleGet extends ExeBaseCmd {

    public static final String _COMMAND = "get angle";

    public CmdCameraAngleGet(Context c, IRequestSendMessage s) {
        super(c, s);
    }
    ...
    public String GetHelp() {
        return String.format("%s - %s", GetCommandText(), context.getString(R.string.wmd_hc_angle_get));
    }
